...
var ASM_CONSTS = {
  7396208: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 7396269: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 7396333: function() {return Module.webglContextAttributes.powerPreference;},  
 7396391: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 7396446: function($0) {performance.now = function() { return $0; };},  
 7396494: function($0) {performance.now = function() { return $0; };},  
 7396542: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _ThirdwebGetNonce(taskId, address, blockTag, cb) {
      // convert taskId from pointer to str and allocate it to keep in memory
      var id = UTF8ToString(taskId);
      var idSize = lengthBytesUTF8(id) + 1;
      var idPtr = _malloc(idSize);
...
var asmLibraryArg = {
  ...
  "ThirdwebGetNonce": _ThirdwebGetNonce,
